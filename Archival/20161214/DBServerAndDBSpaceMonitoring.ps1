...
<# CMS Group IDs - Last Exported on Dec 12, 2016

    2	[AnalysisServicesServerGroup
    1	[DatabaseEngineServerGroup
2023	[DatabaseEngineServerGroup\3DPP
1018	[DatabaseEngineServerGroup\3DPP\Express
2022	[DatabaseEngineServerGroup\3DPP\Standard
2031	[DatabaseEngineServerGroup\AGFA
2045	[DatabaseEngineServerGroup\AGFA\No Access
2032	[DatabaseEngineServerGroup\AGFA\Prod
...
2033	[DatabaseEngineServerGroup\AGFA\UAT
...
2041	[DatabaseEngineServerGroup\AGFA\UAT\2008
    6	[DatabaseEngineServerGroup\Prod
...
2056	[DatabaseEngineServerGroup\Prod\2014
2057	[DatabaseEngineServerGroup\Prod\2016
    7	[DatabaseEngineServerGroup\UAT
...
2055	[DatabaseEngineServerGroup\UAT\2014
2058	[DatabaseEngineServerGroup\UAT\2016
2030	[DatabaseEngineServerGroup\Various
2054	[DatabaseEngineServerGroup\Various\AG Listeners
2026	[DatabaseEngineServerGroup\Various\Aliases
2044	[DatabaseEngineServerGroup\Various\Automed - Vendor License
2043	[DatabaseEngineServerGroup\Various\Deleted Servers
2046	[DatabaseEngineServerGroup\Various\Express
2047	[DatabaseEngineServerGroup\Various\Express\2000
2048	[DatabaseEngineServerGroup\Various\Express\2005
2049	[DatabaseEngineServerGroup\Various\Express\2008
2050	[DatabaseEngineServerGroup\Various\Express\2012
2051	[DatabaseEngineServerGroup\Various\IBM
2052	[DatabaseEngineServerGroup\Various\IBM\2000
2053	[DatabaseEngineServerGroup\Various\IBM\2005+
1019	[DatabaseEngineServerGroup\Various\Legacy
1010	[DatabaseEngineServerGroup\Various\Legacy\Dont Touch 6.5
1020	[DatabaseEngineServerGroup\Various\Legacy\Prod
    12	[DatabaseEngineServerGroup\Various\Legacy\Prod\7
1021	[DatabaseEngineServerGroup\Various\Legacy\UAT
...
2027	[DatabaseEngineServerGroup\Various\Veritas Cluster Nodes
    4	[IntegrationServicesServerGroup
    3	[ReportingServicesServerGroup
    5	[SqlServerCompactEditionServerGroup
#>
...
try
{
    ...
    (
      ...
      SELECT name, server_name
       ...
       WHERE G.GroupID IN (1012, 1013, 1014, 1015, 2055, 2058) -- DatabaseEngineServerGroup\UAT\*
          OR G.GroupID IN (   8,    9,   10,   11, 2056, 2057) -- DatabaseEngineServerGroup\Prod\*
          ...
          OR G.GroupID IN (1018, 2022)                   -- DatabaseEngineServerGroup\3DPP\*
    ORDER BY name"

<#

       WHERE G.GroupID IN (1012, 1013, 1014, 1015, 2055) -- DatabaseEngineServerGroup\UAT\*
          OR G.GroupID IN (8, 9, 10, 11)                 -- DatabaseEngineServerGroup\Prod\*
          OR G.GroupID IN (2040, 2041)                   -- DatabaseEngineServerGroup\AGFA\UAT\*
          OR G.GroupID IN (2034, 2035, 2036)             -- DatabaseEngineServerGroup\AGFA\Prod\*
          OR G.GroupID IN (1018, 2022)                   -- DatabaseEngineServerGroup\3DPP\*
       WHERE server_name LIKE 'chrccs02t%' --'WSSQLTOOLS01T%'
         AND G.GroupID = 1012
#>
            ...
            if (($ServerInstanceIsMonitored) -and ($SQLInstanceAccessible))
            {
                ...
                try
                {
                    ...
                    if ($Results)
                    {
                        ...
                        Write-StatusUpdate -Message "Writing database details to staging table" -Level $Global:OutputLevel_Six -IsTSQL                    
                        ...
                        IF ($SQLVersion -ne 'Microsoft SQL Server 2000')
                        {
                    ...
                    {
                        Write-StatusUpdate -Message "No user databases found on [$SQLServerFQDN]." -Level $Global:OutputLevel_Two -WriteToDB
                        $SQLInstanceAccessible = $false
                    }
