...
{ 
    ...
    [Parameter(Position=7, Mandatory=$false)] [Int32]$MaxLength=0,
 ...
 try {
    ...
    { 
        ...
        {
            $dataType = new-object ("Microsoft.SqlServer.Management.Smo.DataType") "$sqlDbType", 15,2
        }
        else 
        { $dataType = new-object ("Microsoft.SqlServer.Management.Smo.DataType") "$sqlDbType" } 
